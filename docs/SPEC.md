...
- external model/provider API transport, provider credentials/authentication, tokenizer/token accounting, provider data-egress/billing/retry semantics, ContextSlice/CAS, context caching, warm executors, or locality scheduling;
