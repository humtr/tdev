...
D0017 selects and source-verifies the immutable full-context logical reference plus bounded packed/hybrid trusted receiver-local representation. Deterministic ContextSlice remains unselected, persistent/shared context CAS remains conditional under D0022, and warm execution/external-provider lifecycle remains a separate D0018 contract.
