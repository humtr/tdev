...
- Acceptance evidence: `docs/evidence/group-f-d0048-r1-current-source-qualification-20260906.json`, `docs/evidence/group-f-d0043-r4-physical-m0-pass-current-20260906.json`
