...
- Deployed attestor evidence: `docs/evidence/group-f-d0040-r1-deployed-attestor-admission-2026-08-28.json` — exact `25b6afcb…` Cloudflare provider/runtime public-key binding, active-version join and stable `UNREGISTERED` route-owner preservation PASS
- Verification evidence: `docs/evidence/group-f-d0040-r1-producer-custody-qualification-2026-08-28.json` — protected producer/custody boundary, exact evidence-specific package observation, caller digest/context denial, public-envelope verification and fresh deployed public-verifier readback PASS; evidence semantics/per-evidence observation truth remain with their existing owners
