...
- Deployed attestor evidence: `docs/evidence/group-f-d0040-r1-deployed-attestor-admission-2026-08-28.json` — exact `25b6afcb…` Cloudflare provider/runtime public-key binding, active-version join and stable `UNREGISTERED` route-owner preservation PASS; producer observation/custody qualification remains separate
