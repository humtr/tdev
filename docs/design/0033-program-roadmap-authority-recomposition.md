...
- Revision 3 implementation source: `8decd6e910a4b3e9572de37478a09a6633236449`, after accepted lifecycle commit `615e979fb8026c1c704a38c3a8a0a4013320a73f` and D0031 r7 verification publication `b12509e9d645ccd6156c22f21ce64a56c91f8cbf`.
- Revision 3 verification evidence: `docs/evidence/group-f-d0033-r3-blocked-lifecycle-vocabulary-verification-2026-08-18.json`; focused governance 41/41 and the exact four-command source gate passed, including 379/379 coverage-run tests, in tmcp Jobs `job_95i_7e68536892` and `job_95o_2bb4990135`.
