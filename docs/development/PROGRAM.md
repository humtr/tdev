...
The current runnable line remains owned only by `WORKBOARD.md`. Its minimum route selects D0043@r2 as the cheapest physical falsifier, then transitions directly into D0046 without treating the routing/evidence update as a user-facing completion point.
