...
- **Status:** verified revision 1 — 2026-08-14
...
- **Evidence:** inventory `docs/evidence/group-f-d0032-mvp-qualification-inventory-2026-08-14.json`; acceptance `docs/evidence/group-f-d0032-qualification-authority-acceptance-2026-08-14.json`; verification `docs/evidence/group-f-d0032-qualification-authority-verification-2026-08-14.json`.
...
- **Exit:** satisfied for revision 1: the old MVP bytes are preserved exactly, QUALIFICATION is the unique live proof-method owner, all 78 method pairs survive unchanged, stale/duplicate/missing owner states fail closed, governance tests pass 17/17, supported non-hard-link source/coverage pass 260/260, and product `src/` changed zero paths. Exact all-test/coverage on this connected Termux filesystem remain separately platform-unqualified only for the inherited 25 ImmutableJournal `link(2) EACCES` failures.
