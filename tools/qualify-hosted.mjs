...
async function main(){
 ...
 const attempt={identityNamespace:/** @type {const} */('tdev'),installationId:'hosted-qualification',repositoryId:'github-'+process.env.GITHUB_REPOSITORY_ID,workId:'negative-boundary',actionId:'probe',attemptId:'a'+process.env.GITHUB_RUN_ID,attempt:'1',ownerEpoch:'1'};
