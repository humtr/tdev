...
import {inspectHardCutover,applyHardCutover,cleanupHardCutoverHeldDesign} from '../src/release/hard-cutover-recovery.mjs';
...
async function main(){
 ...
 requireThat(helperConfigFile&&nativeConfigFile&&['inspect','apply','cleanup-held-design'].includes(String(mode)),'INVALID_ARGUMENT');
