...
- D0019@r2 remains production-verified as the single semantic Case owner. D0020@r1 is reopened only for three ACR-confirmed falsifiers: A7 post-spawn historical `no_handle`/capacity-release truth, B3 exact connect-response replay/socket-incarnation close fencing, and B5 terminal-delivery bounded GC/high-water/replay horizon. Unaffected previously verified D0020 facts remain valid under `SDD.md`; no D0020 Class 2 implementation is authorized until a corrected revision is accepted. Group F remains active, the runnable frontier remains empty during this reopened state, and no provisional successor is auto-activated.
