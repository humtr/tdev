...
- D0020@r1 — `docs/design/0020-agent-connection-delivery-and-aggregate-capacity.md` — implement the accepted Agent delivery authority vertical slice

## Selected next action

- D0020@r1 — implement the accepted Agent delivery authority vertical slice
...
- D0019@r2 is production-verified. The elected SQLite-backed CaseDO remains the single semantic owner for placed Cases under the verified D1 placement/fencing/recovery/capacity/rollout boundary; D0020@r1 Agent delivery/connection implementation is now the selected runnable Group F gate, without implying provider/runtime verification.
