...
- D0020@r2 — `docs/design/0020-agent-connection-delivery-and-aggregate-capacity.md` — implement the accepted A7/B3/B5 correction and requalify only the affected proof layers

## Selected next action

- D0020@r2 — implement the accepted A7/B3/B5 correction and requalify only the affected proof layers
...
- D0019@r2 remains production-verified as the single semantic Case owner. D0020@r2 is accepted as the same-owner-family correction for the three ACR-confirmed reopened scopes: A7 post-spawn historical `no_handle`/capacity-release truth, B3 exact connect-response replay/socket-incarnation close fencing, and B5 terminal-delivery bounded GC/high-water/replay horizon. Unaffected Revision-1 verified facts remain valid under `SDD.md`; D0020@r2 is the runnable and selected Class-2 correction gate. D0027 remains research-only until the corrected scopes are requalified, and no other provisional successor is auto-activated.
