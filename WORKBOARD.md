...
| P6 | D0003, D0001/D0002 | `src/integration/`, ref-composition/effect tests | Pure target composer, exact frozen commit and provider CAS/reconciliation; lost push response produces one commit, overlapping delta rejects. |
