...
const agentId = 'd0044-provider-import-20260902-r18';
...
async function main() {
  ...
  const successorActive = assertOk('activate successor', await invokeWithAuthPropagation(qualificationToken, '/qualification/d0044/delivery/v1', { profile, routeHostKey: generation2HostKey, rpc: deliveryRpc(generation2, 'activate_route', { electionState: committed }) }, 'activate successor'));
