...
const agentId = 'd0044-provider-response-loss-20260903-r25';
...
async function main() {
  ...
  const electionForActivation = assertOk('read election before successor activation', await invokeWithAuthPropagation(qualificationToken, '/qualification/d0044/election/v1', { profile, operation: 'readAgentRouteElection', agentId, payload: {} }, 'read election before activation'));
