...
async function main() {
  ...
  const replayDiagnostic = await authInvoke(token, '/qualification/d0044/election/v1', { profile, operation: 'd0044CommitAgentRouteCutoverReplayDiagnostic', agentId, payload: { cutoverRequestId: 'rc1:1' } }, 'replay diagnostic');
