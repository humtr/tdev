...
async function world(){
 ...
 const effect={effectId:'retained-upload',releaseId:D,inputDigest:recordDigest('tdev.fixture-upload.v1',{releaseId:D}),artifactDigest:D,sourceCommitOid:C,expectedVersionId:'version-before'};
