...
const legacySource={...f.source,treeOid:'sha1:'+'9'.repeat(40)},legacyIdentities={...f.definition.identities,trustedRunnerDigest:D(0)},legacyDefinition={...f.definition,identities:legacyIdentities,policy:managedPolicy(legacyIdentities,'tdev'),config:{...f.definition.config,executionShape:undefined}};
