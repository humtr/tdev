...
- `repository.ts` owns narrow SQLite transaction primitives. It does not own public capability semantics, Worker routing, authentication, deployment, or Agent dispatch.
