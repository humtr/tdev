...
export class ResultPreparer {
 ...
 const current=await this.o.repository.readCommit(this.o.binding,head);requireThat(base.source.manifestDigest!==work.candidate.manifestDigest,'NO_CHANGE');const tree=await this.o.repository.writeTree(composeTrees(base.source,work.candidate,current.source));
