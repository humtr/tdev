...
export class ResultPreparer {
 ...
 const current=await this.o.repository.readCommit(this.o.binding,head);
 const candidate=await this.o.repository.readTree(work.candidate.treeOid);
 requireThat(candidate.manifestDigest===work.candidate.manifestDigest,'INTEGRITY_FAILURE','Candidate object identity changed');
