...
export class DurableGitSender {
 ...
 /** A supplied fence is synchronous and executes in the same SQLite transaction
  * immediately before a new physical invocation becomes remote-possible.
  * @param {Effect} effect @param {(tx:import('../storage/ledger.mjs').Transaction)=>void} [fence] */
