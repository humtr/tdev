...
export async function managedDefinition(repository,source){
 ...
 const config=/** @type {{origin:string,image:string,seccompDigest:string,sessionLifetimeMs:number,idleTimeoutMs:number}} */(/** @type {unknown} */(await read('config/managed-execution.json')));
