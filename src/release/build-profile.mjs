 ...
 * @param {string} imageDigest @param {'tdev'} [namespace] @returns {import('../contracts/ports.js').Profile} */
export function releaseBuildProfile(imageDigest,namespace='tdev'){
 digest(imageDigest);requireThat(namespace==='tdev','INVALID_ARGUMENT','Build profile namespace');
...
/** @param {import('../contracts/ports.js').Profile} profile @param {string} imageDigest @param {'tdev'} [namespace] */
...
/** @param {import('../contracts/ports.js').ExecutionIdentity} execution @param {string} imageDigest @param {'tdev'} [namespace] */
