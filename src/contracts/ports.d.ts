...
export interface H2ActionRef { version:1; memberTupleDigest:Digest; compositionIdentity:Digest; leaderActionId:Id;
  tupleObjectDigest:Digest; deltaObjectDigest:Digest; role:'leader'|'follower'; effectId:Id|null }
export interface H2ResultRef { version:1; memberTupleDigest:Digest; compositionIdentity:Digest; leaderActionId:Id;
...
export interface PreparedResult { resultId:Id; repositoryId:Id; bindingEpoch:Revision; workId:Id; generation:Revision;
  ...
  metadata:{author:string;committer:string;timestamp:number;message:string}; execution:ExecutionIdentity; h2?:H2ResultRef }
