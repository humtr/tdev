...
export async function createProductionControl(o){
 ...
 const sessions=new ManagedSessions({ledger:o.ledger,targets:o.targets,config:{repositoryOwnerId:i.repositoryOwnerId,repositoryFullName:i.repositoryFullName,approvedCommit:i.approvedCommitOid.slice(5),trustedRunnerDigest:definition.identities.trustedRunnerDigest,sessionTimeoutMs:definition.config.sessionLifetimeMs,capacity:o.capacity,sealDigest:o.enrollment.sealDigest}});
