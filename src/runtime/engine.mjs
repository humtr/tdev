...
export class DevelopmentEngine {
 ...
 constructor(options){
  this.o=options;this.ledger=options.ledger;this.binding=options.binding;this.now=options.now??Date.now;this.arbiter=options.arbiter??null;
  this.coordinator=new WorkCoordinator(options.ledger,{executionCapacity:options.capacity,now:this.now});this.arbiter?.register(this);
