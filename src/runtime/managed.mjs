...
export async function createManagedControl(options){
 ...
 const verifier=githubExecutorVerifier({origin:o.origin,installationId:o.binding.installationId},createRemoteJWKSet(new URL('https://token.actions.githubusercontent.com/.well-known/jwks')),(sessionId,freshProvider)=>provider.authorization(sessionId,freshProvider));
