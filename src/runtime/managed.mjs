...
export async function createManagedControl(options){
 ...
 const sessions=new ManagedSessions({ledger:o.ledger,targets:o.targets,config:{repositoryOwnerId:e.repositoryOwnerId,repositoryFullName:e.repositoryFullName,approvedCommit:e.approvedCommitOid.slice(5),trustedRunnerDigest:definition.identities.trustedRunnerDigest,sessionTimeoutMs:definition.config.sessionLifetimeMs,capacity:o.capacity,sealDigest:enrolled.sealDigest}});
