...
export async function createManagedControl(options){
 ...
 const currentController=definition.config.workflowPath==='.github/workflows/tdev-executor.yml',controllerNamespace=/** @type {'tdev'|'dev2'} */(currentController?'tdev':'dev2'),productionNamespace=/** @type {'tdev'|'dev2'|null} */(production?(production.definition.config.workflowPath==='.github/workflows/tdev-executor.yml'?'tdev':'dev2'):null);
