...
defs.error=object({code:{enum:[...ERROR_CODES]},message:string,retry:object({sameRequest:boolean,afterMs:nullable(number)}),facts:object({currentHead:ref('oid'),expectedHead:ref('oid'),observedAt:ref('timestamp')},[])});
